...
return new class extends Migration {
    public function up()
    {
        Schema::create('mahasiswas', function (Blueprint $table) { // yang berarti menyuruh untuk membuatkan tabel 'mahasiswas' di DB, sesuai isi kolomdibawah ini, yang mana Laravel secara otomatis menambahkan‘s’.
