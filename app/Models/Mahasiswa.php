...
class Mahasiswa extends Model
{
     ...
     * @var array
     */
    protected $casts = [ // mengubah tipe data dari kolom di database ke tipe dataPHP sehingga bisa mengambil data parsial, seperti ambil tanggalnya saja ataujamnya saja.
        'created_at' => 'datetime',
        'updated_at' => 'datetime',
    ];
}
